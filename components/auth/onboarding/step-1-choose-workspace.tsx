    ...
    <div className="flex flex-col justify-center w-full max-w-2xl mx-auto py-2">
      ...
      <div className="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-2">
        ...
        <div
          ...
          className={`group relative flex flex-col justify-between rounded-2xl border-2 p-5 cursor-pointer transition-all bg-white ${
        ...
        >
          ...
          <div>
            ...
            <div className="mt-3 text-center space-y-1.5">
              <h3 className="text-base font-bold text-slate-900">Individual</h3>
