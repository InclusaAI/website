...
export function SignupRoleSelection() {
  ...
  return (
    <div className="flex flex-col justify-between w-full max-w-3xl mx-auto py-2">
      {/* Header Info */}
      <div className="space-y-1 text-left">
        <span className="text-xs font-bold text-brand-intelligence uppercase tracking-wide">
      ...
      <div className="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-2">
        ...
        <div
          ...
          className={`group relative flex flex-col justify-between rounded-3xl border-2 p-5 sm:p-6 cursor-pointer transition-all bg-white ${
            selectedRole === "audience"
              ? "border-brand-intelligence shadow-lg ring-2 ring-brand-intelligence/20"
              : "border-border-default hover:border-border-strong hover:shadow-sm"
          }`}
        >
          {/* Active Checkmark Badge (matching brand-intelligence blue) */}
          {selectedRole === "audience" && (
          ...
          <div>
            ...
            <div className="flex justify-center">
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-blue-100/70 text-brand-intelligence">
            ...
            <div className="mt-3 text-center">
              ...
              <h3 className="text-base sm:text-lg font-bold text-slate-900">Audience Member</h3>
            ...
            {/* Divider */}
            <div className="my-3.5 border-t border-border-default/60" />

            {/* 3 Features List */}
            <div className="space-y-2.5 text-left">
              {/* Feature 1 */}
              <div className="flex items-start gap-2.5">
                <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-md bg-purple-100 text-purple-600 font-bold text-[9px] mt-0.5">
                  CC
                </span>
                <div>
              ...
              {/* Feature 2 */}
              <div className="flex items-start gap-2.5">
                <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-md bg-teal-100 text-teal-600 mt-0.5">
              ...
              {/* Feature 3 */}
              <div className="flex items-start gap-2.5">
                <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-md bg-indigo-100 text-indigo-600 mt-0.5">
          ...
          {/* Bottom "Best for" Box */}
          <div className="mt-4 rounded-2xl bg-[#F8FAFD] p-3 text-left border border-border-default/60">
            <span className="text-[9.5px] font-bold text-text-tertiary uppercase tracking-wider">
              Best for
            </span>
        ...
        >
          {/* Active Checkmark Badge (matching success emerald green) */}
          {selectedRole === "presenter" && (
            <div className="absolute top-4 right-4 flex h-6 w-6 items-center justify-center rounded-full bg-success text-white shadow-xs">
              <Check className="h-3.5 w-3.5 stroke-[3]" />
            </div>
          )}
          ...
          <div>
            {/* Card Icon */}
            <div className="flex justify-center">
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-emerald-100/70 text-success">
            ...
            <div className="mt-3 text-center">
              ...
              <h3 className="text-base sm:text-lg font-bold text-slate-900">Presenter</h3>
              <p className="mt-1 text-[11px] text-text-secondary leading-normal">
            ...
            <div className="space-y-2.5 text-left">
              {/* Feature 1 */}
              <div className="flex items-start gap-2.5">
                <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-md bg-emerald-100 text-success font-bold text-[9px] mt-0.5">
                  CC
                </span>
                <div>
              ...
              {/* Feature 3 */}
              <div className="flex items-start gap-2.5">
                <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-md bg-emerald-100 text-success mt-0.5">
          ...
          {/* Bottom "Best for" Box */}
          <div className="mt-4 rounded-2xl bg-emerald-50/50 p-3 text-left border border-emerald-100/60">
