    ...
    <div className="flex flex-col justify-center w-full max-w-3xl mx-auto py-1 space-y-3">
      ...
      <div className="flex items-center justify-between pt-2 border-t border-border-default/50">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-xl bg-brand-intelligence px-6 py-2.5 text-xs sm:text-sm font-semibold text-white shadow-md transition-all hover:bg-primary-hover hover:shadow-lg"
        >
          <span>Continue</span>
