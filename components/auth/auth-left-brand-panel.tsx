  ...
  return (
    <div className="relative isolate flex h-full w-full flex-col justify-between overflow-hidden p-6 sm:p-7 lg:p-8">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden bg-surface-page">
        ...
        <div className="absolute inset-x-0 top-0 h-44 bg-gradient-to-b from-surface-default/95 via-surface-default/50 to-transparent pointer-events-none -z-10" />
      </div>
      ...
      <div className="relative z-10 space-y-4">
        ...
        <div className="flex flex-wrap items-center gap-2 pt-0.5">
          {/* Live Captions */}
          <div className="flex items-center gap-1.5 rounded-lg border border-border-default/90 bg-surface-default/90 px-2.5 py-1 shadow-xs backdrop-blur-sm">
            <span className="flex h-4.5 w-4.5 items-center justify-center rounded bg-purple-100 text-purple-600 font-bold text-[8.5px]">
              CC
            </span>
            <div>
              <p className="text-[10.5px] font-bold text-text-primary leading-tight">Live Captions</p>
          ...
          <div className="flex items-center gap-1.5 rounded-lg border border-border-default/90 bg-surface-default/90 px-2.5 py-1 shadow-xs backdrop-blur-sm">
            ...
            <div>
              <p className="text-[10.5px] font-bold text-text-primary leading-tight">Translation</p>
          ...
          <div className="flex items-center gap-1.5 rounded-lg border border-border-default/90 bg-surface-default/90 px-2.5 py-1 shadow-xs backdrop-blur-sm">
            ...
            <div>
              <p className="text-[10.5px] font-bold text-text-primary leading-tight">Sign Language</p>
      ...
      {/* Bottom Privacy Banner with Backdrop Filter Blur */}
      <div className="relative z-10 mt-auto pt-4">
        <div className="flex items-center gap-2.5 rounded-xl border border-border-default/70 bg-white/70 p-3 shadow-xs backdrop-blur-md">
          ...
          <div>
            <h4 className="text-[11.5px] font-bold text-text-primary">Your privacy matters</h4>
